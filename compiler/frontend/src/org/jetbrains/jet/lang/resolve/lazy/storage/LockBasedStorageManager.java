...
public class LockBasedStorageManager implements StorageManager {
    ...
    private static <V> V unescapeNull(@NotNull Object value) {
    ...
    @NotNull
    @SuppressWarnings("unchecked")
    private static <V> Object escapeNull(@Nullable V value) {
    ...
    private static class LockBasedLazyValue<T> implements NullableLazyValue<T> {
        ...
        public T compute() {
            Object _value = value;
            if (_value != null) return unescapeNull(_value);
    ...
    private static class MapBasedMemoizedFunction<K, V> implements MemoizedFunctionToNullable<K, V> {
        ...
        public V fun(@NotNull final K input) {
            ...
            if (value != null) return unescapeNull(value);
            ...
            synchronized (lock) {
                ...
                Object oldValue = cache.put(input, escapeNull(typedValue));
